...
class ConnectFailure extends BaseRoomEvent {
  ...
  const ConnectFailure(RoomModel roomModel, this.exception) : super(roomModel);
...
class Disconnected extends BaseRoomEvent {
  ...
  const Disconnected(RoomModel roomModel, this.exception) : super(roomModel);
...
class ParticipantConnected extends BaseRoomEvent {
  ...
  const ParticipantConnected(RoomModel roomModel, this.connectedParticipant) : super(roomModel);
...
class ParticipantDisconnected extends BaseRoomEvent {
  ...
  const ParticipantDisconnected(RoomModel roomModel, this.disconnectedParticipant) : super(roomModel);
...
class Reconnecting extends BaseRoomEvent {
  ...
  const Reconnecting(RoomModel roomModel, this.exception) : super(roomModel);
...
class DominantSpeakerChanged extends BaseRoomEvent {
  ...
  const DominantSpeakerChanged(RoomModel roomModel, this.dominantSpeaker) : super(roomModel);
